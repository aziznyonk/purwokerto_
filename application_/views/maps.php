    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url(); ?>index.php/dashboard" class="logo" style="height: auto">
                <!--                    <img src="--><?php //echo base_url(); ?><!--assets/images/logo_pdam.png" alt="homepage" style="width: 35px;"/>-->
...
<li>
    ...
    <ul class="pipaLegenda">
        <li><a href="#"><hr class="pipa dm_12"> Pipa 12,5 mm</a></li>
        <li><a href="#"><hr class="pipa dm_20"> Pipa 20 mm</a></li>
        <li><a href="#"><hr class="pipa dm_25"> Pipa 25 mm</a></li>
        <li><a href="#"><hr class="pipa dm_40"> Pipa 40 mm</a></li>
        <li><a href="#"><hr class="pipa dm_45"> Pipa 45 mm</a></li>
        <li><a href="#"><hr class="pipa dm_50"> Pipa 50 mm</a></li>
        <li><a href="#"><hr class="pipa dm_65"> Pipa 65 mm</a></li>
        <li><a href="#"><hr class="pipa dm_75"> Pipa 75 mm</a></li>
        <li><a href="#"><hr class="pipa dm_80"> Pipa 80 mm</a></li>
        <li><a href="#"><hr class="pipa dm_100"> Pipa 100 mm</a></li>
        <li><a href="#"><hr class="pipa dm_125"> Pipa 125 mm</a></li>
        <li><a href="#"><hr class="pipa dm_150"> Pipa 150 mm</a></li>
        <li><a href="#"><hr class="pipa dm_200"> Pipa 200 mm</a></li>
        <li><a href="#"><hr class="pipa dm_250"> Pipa 250 mm</a></li>
        <li><a href="#"><hr class="pipa dm_300"> Pipa 300 mm</a></li>
        <li><a href="#"><hr class="pipa dm_400"> Pipa 400 mm</a></li>
        <li><a href="#"><hr class="pipa dm_500"> Pipa 500 mm</a></li>
    </ul>
</li>
</ul>
</div>
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_M.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_I, 'I'/*,markerClusterI*/);$("#loadManometer").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_V.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_V, 'V'/*,markerClusterV*/);$("#loadVelve").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_D.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_D, 'D'/*,markerClusterD*/);$("#loadDop").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_F.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_F, 'FH'/*,markerClusterF*/);$("#loadFhydrant").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_G.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_G, 'G'/*,markerClusterG*/);$("#loadGiboult").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_J.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_J, 'J'/*,markerClusterJ*/);$("#loadJembatan").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_K.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_K, 'K'/*,markerClusterK*/);$("#loadKnie").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_V.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_Po, 'Po'/*,markerClusterPo*/);$("#loadPompa").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_T.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_T, 'T'/*,markerClusterT*/);$("#loadTee").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_P.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_P, 'P'/*,markerClusterP*/);$("#loadPelanggan").hide();}
                            });
                        }else{
            ...
            if ($(this).is(':checked')){
                ...
                if(markers_Mb.length == 0){
                            ...
                            $.ajax({
                                ...
                                success : function (response){makeMarker(response, markers_Mb, 'Mb'/*,markerClusterMb*/);$("#loadPelangganM").hide();}
                            });
                        }else{
            ...
            function () {
                if ($(this).is(':checked')){
                    ...
                    $.ajax({
                        ...
                        success : function (response) {makePipaPolyline(response, pipaRencanaPath);$('#loadPipaR').hide();}
            ...
            function () {
                if ($(this).is(':checked')){
                    ...
                    $.ajax({
                        ...
                        success : function (response) {makePipaPolyline(response, pipaPath);$('#loadPipa').hide();}
        ...
        $("#search_form").submit(function(e) {
            ...
            if(search === ''){
                ...
                $.ajax({
                    ...
                    success : function (response) {searchPelanggan(response);}
                });
            }
        });
    });
    ...
    var markers_T	= new Array();
            ...
            function makeMarker(response, markers_pelanggan, A/*, Cluster*/) {
                ...
                switch (A) {
                    ...
                    case 'D' : color = '7e3d00';break;
                    case 'FH' : color = '175b88';break;
                    case 'G' : color = 'e31a1c';break;
                    case 'J' : color = 'ff6ff3';break;
                    case 'K' : color = 'd89972';break;
                    case 'Po': color = 'f4e943';break;
                    case 'T' : color = '7e21e6';break;
                }
            ...
            function makePipaPolyline(response, pipaPath) {
                for (let i in response){
                    ...
                    let color;
                    switch (A) {
                        case '12.500000000000000' : color = '#a53aa3';break;
                        case '20.000000000000000' : color = '#a0561a';break;
                        case '25.000000000000000' : color = '#59e4ff';break;
                        case '40.000000000000000' : color = '#33a02c';break;
                        case '45.000000000000000' : color = '#36d962';break;
                        case '50.000000000000000' : color = '#175b88';break;
                        case '65.000000000000000' : color = '#a53aa3';break;
                        case '75.000000000000000' : color = '#7e21e6';break;
                        case '80.000000000000000' : color = '#d89972';break;
                        case '100.000000000000000': color = '#e31a1c';break;
                        case '125.000000000000000': color = '#6b5b04';break;
                        case '150.000000000000000': color = '#ff7f00';break;
                        case '200.000000000000000': color = '#ee88ed';break;
                        case '250.000000000000000': color = '#f4e943';break;
                        case '300.000000000000000': color = '#7e3d00';break;
                        case '400.000000000000000': color = '#e41e8b';break;
                        case '500.000000000000000': color = '#ff6ff3';break;
                    }
