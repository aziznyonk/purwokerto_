	...
	<section class="content">
        <div class="box">
			<div class="box-header with-border">
                <h3 class="box-title">Edit Data Pipa Rencana</h3>
            </div>
			<div class="box-body">
				<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/pipa/save_pipaRencana" method="post">
					<fieldset>
						<?php
						...
						?>			
									...
									<div class="form-group">
									  ...
									  <span class="help-block">Kode Manometer</span>  
									  </div>
									</div>
									<div class="form-group">
